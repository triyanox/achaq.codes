...
function Header() {
  ...
  return (
    <section className="p-2 mt-0 fixed h-12 w-full z-20 top-0  ">
      <div>
        <nav className="bg-opacity-50 dark:bg-opacity-50 backdrop-blur-xl firefox:bg-opacity-0 firefox:dark:bg-opacity-0 firefox:bg-white firefox:dark:bg-black p-3 flex items-center flex-row px-8 mx-2 lg:mx-12 rounded-3xl h-12">
