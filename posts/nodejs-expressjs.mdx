---
title: Build your first API with nodejs and express
date: Feb 16 2022
description: Build your first REST API with express which is a lighweight nodejs framework
thumbnailUrl: "/static/images/nodejs-expressjs.png"
...
<Imagecomponent
  ...
  alt={`Build your first API with nodejs and express`}
  width={`1920`}
  height={`1080`}
  priority
/>
...
I hope you enjoyed this article and if I made a mistake correct me because I'm just starting out and everyday is an
